...
class Segment:
    def __init__(self, p1, p2, angle1, angle2, **kw):
        ...
        self.angle1 = angle1
        self.angle2 = angle2
        self.numpoints = kw.get("numpoints", 1000)  # adjusts how many points each segment contains --> prevents holes
        r = kw.get("r", 0.3)
...
def get_bezier_curve(a, rad=0.2, edgy=0.0):
...
def random_shape(size, shape_type, radius=0.4, edges=0.0):
    ...
    x_coord, y_coord, _ = get_bezier_curve(array, rad=radius, edgy=edges)
